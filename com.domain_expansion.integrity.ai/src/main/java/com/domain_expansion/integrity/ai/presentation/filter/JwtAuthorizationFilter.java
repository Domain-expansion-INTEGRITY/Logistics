package com.domain_expansion.integrity.ai.presentation.filter;
...
import com.domain_expansion.integrity.ai.common.security.UserDetailsImpl;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if (StringUtils.hasText(tokenValue)) {
            if (!jwtUtils.checkValidJwtToken(tokenValue)) {
                throw new AiException(ExceptionMessage.AUTHORIZATION);
            }
