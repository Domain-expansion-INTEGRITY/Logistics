package com.domain_expansion.integrity.company.infrastructure.filter;

import com.domain_expansion.integrity.company.common.jwt.JwtUtils;
...
public class JwtAuthorizationFilter extends OncePerRequestFilter {
    ...
    public void setAuthentication(Claims claims) {
        ...
        UserDetailsImpl userDetails = new UserDetailsImpl(Long.valueOf(userId), authorities, roles);
