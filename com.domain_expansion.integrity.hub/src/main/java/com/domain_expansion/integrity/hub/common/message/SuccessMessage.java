...
public enum SuccessMessage {
    ...
    SUCCESS_GET_HUB_ROUTE(HttpStatus.CREATED, "허브 이동정보 단건 조회가 완료 되었습니다."),
    SUCCESS_GET_ALL_HUBS_ROUTE(HttpStatus.CREATED, "허브 이동정보 목록 조회가 완료 되었습니다."),
    SUCCESS_UPDATE_HUB_ROUTE(HttpStatus.CREATED, "허브 이동정보 수정이 완료 되었습니다."),
    SUCCESS_DELETE_HUBS_ROUTE(HttpStatus.CREATED, "허브 이동정보 삭제가 완료 되었습니다.");
